			...
			<div class="container">
				...
				<div class="collapse nav-collapse">
					<ul class="nav pull-right">
						<li class="#"><a href="<?php echo base_url();?>index.php/administrator/home"><i class="icon-home"></i> Home</a></li>
                       	<li class="dropdown" id="preview-menu"><a href="<?php echo base_url();?>index.php/administrator/artikel" ><i class="icon-book"></i> Buku</a></li>
						<li><a href="<?php echo base_url();?>index.php/administrator/hubungi"><i class="icon-envelope"></i> <span class="notifikasi"></span> Hubungi Kami</a></li>
                        <li><a href="<?php echo base_url();?>index.php" target="_blank"><i class="icon-globe"></i> <span class="notifikasi"></span> Webiste</a></li>
                        <li class="dropdown" id="preview-menu"><a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="icon-user"></i><?php echo $this->session->userdata('nama_lengkap');?> <b class="caret"></b></a>
                        <ul class="dropdown-menu">
							<li><a href="<?php echo base_url();?>index.php/administrator/profil/index"><i class="icon-user"></i> Profil</a></li>	
                        	<li><a href="<?php echo base_url();?>index.php/administrator/login/logout"><i class="icon-off"></i> Logout</a></li>	
                        </ul>
                        </li>
					</ul>
				</div>
